    ...
    <section className="flex flex-col w-full text-center" data-aos='fade-up'>
      ...
      <div className="flex sm:flex-row sm:flex-wrap flex-col w-full justify-center items-center gap-6 my-6 ">
        <div className="bg-brand-400 rounded-2xl flex flex-col justify-around w-10/12 sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img src="/carImages/yarisHatch.png" alt="Yaris Hatch" className="hover:scale-x-[-1] trasition-all duration-300  max-h-[200px] w-auto object-contain mx-auto " />
        ...
        <div className="bg-brand-400 rounded-2xl w-10/12 flex flex-col justify-around sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img src="/carImages/civic.png" alt="Civic" className=" hover:scale-x-[-1] trasition-all duration-300  max-h-[200px] w-auto object-contain mx-auto " />
          <div className="flex justify-around content-center items-center  w-full">
        ...
        <div className="bg-brand-400 rounded-2xl w-10/12 flex flex-col justify-around sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img
            ...
            className="scale-x-[-1] hover:scale-x-[1] trasition-all duration-300  max-h-[200px] w-auto object-fill mx-auto"
            alt="Palisade"
          />
          <div className="flex justify-around content-center items-center  w-full">
        ...
        <div className="bg-brand-400 rounded-2xl w-10/12 flex flex-col justify-around sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img
            ...
            className="scale-x-[-1] hover:scale-x-[1] trasition-all duration-300 max-h-[200px]   w-auto object-contain mx-auto "
            alt="Ranger"
          />
          <div className="flex justify-around content-center items-center   w-full">
        ...
        <div className="bg-brand-400 rounded-2xl w-10/12 flex flex-col justify-around sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img src="/carImages/seal.png" alt="Seal" className=" hover:scale-x-[-1] trasition-all duration-300  max-h-[200px] w-auto object-contain mx-auto" />
          <div className="flex justify-around content-center items-center  w-full">
