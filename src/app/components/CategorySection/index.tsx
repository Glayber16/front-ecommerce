  ...
  return (
    <section className="flex flex-col w-full text-center">
      ...
      <div className="flex sm:flex-row sm:flex-wrap flex-col w-full justify-center items-center gap-6 my-6 ">
        <div className="bg-brand-500 rounded-2xl w-10/12 sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img src="/carImages/yarisHatch.png" alt="Yaris Hatch" className="sm:h-[200px] w-auto object-contain mx-auto " />
        ...
        <div className="bg-brand-500 rounded-2xl w-10/12 sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img src="/carImages/civic.png" alt="Civic" className="sm:h-[200px] w-auto object-contain mx-auto " />
          <div className="flex justify-around content-center items-center  w-full">
        ...
        <div className="bg-brand-500 rounded-2xl w-10/12 sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img
            ...
            className="scale-x-[-1] sm:h-[200px] w-auto object-contain mx-auto"
            alt="Palisade"
          />
          <div className="flex justify-around content-center items-center  w-full">
        ...
        <div className="bg-brand-500 rounded-2xl w-10/12 sm:flex sm:flex-col sm:justify-around sm:w-[500px] h-[350px] p-5">
          <img src="/carImages/seal.png" alt="Seal" className="sm:h-[200px] w-auto object-contain mx-auto" />
          <div className="flex justify-around content-center items-center  w-full">
