    ...
    <div className='flex flex-col min-h-screen bg-white'>
        ...
        <div className='flex flex-1 flex-col items-center justify-center center w-full'>
            <form  className='bg-[#e9e4e9] text-[#000000] flex flex-col rounded-xl p-5 gap-5 border-2 text-center border-black'>
                ...
                <button className='rounded-xl border border-black p-2 bg-[#fa1e0b] text-black hover:bg-[#e9e4e9]' type='submit'>Entrar</button>
            </form>
            <div className='text-black p-5'>
                <h1>Ainda não tem uma conta ?? <Link href="/Cadastro">Faça agora</Link> </h1>
            </div>
        </div>
    </div>
  )
